...
export interface Soup {
  ...
  wrongPrices?: { bowl: number[]; cup: number[] }; // ✅ Added wrong price options
}
...
export const salads: Salad[] = [
  {
    ...
    wrongPrices: [10.49, 12.99, 13.49] // ✅ Added wrong answers
  },
  {
    ...
    price: 11.29,
    dressings: ["Honey Mustard"],
    wrongPrices: [9.99, 10.79, 12.49] // ✅ Added wrong answers
  },
  {
    ...
    wrongPrices: [9.99, 10.99, 12.99] // ✅ Added wrong answers
  },
];
...
export const soups: Soup[] = [
  {
    ...
    wrongPrices: {
      bowl: [3.99, 5.29, 5.79], // ✅ Added wrong answers for bowl
      cup: [2.99, 3.29, 4.49],  // ✅ Added wrong answers for cup
    }
  },
];
